...
+-----------------------------------+---------------+---------------+----------------+----------------+
|                                   | **Bivariant** | **Bivariant** | **Full Model** | **Full Model** |
|                                   |               |               |                |                |
|                                   | Parameters    | P-value       | Parameters     | P-value        |
+===================================+:=============:+:=============:+:==============:+:==============:+
| Time                              | 0.03259       | 0.6498        | 0.0500         | 0.4215         |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **Parent Marital Status**         |               |               |                |                |
+-----------------------------------+---------------+---------------+----------------+----------------+
| In a domestic relationship        | 0.2871        | 0.0561        | | 0.3778       | **0.0083\      |
|                                   |               |               |                | **\*\*\*       |
+-----------------------------------+---------------+---------------+----------------+----------------+
| Married                           | 0.0994        | 0.3773        | 0.2392         | **0.0306**\    |
|                                   |               |               |                | **\*\*\***     |
+-----------------------------------+---------------+---------------+----------------+----------------+
| Age                               | 0.01913       | 0.2764        | 0.0005         | 0.9756         |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **Urban vs. semi-urban**          |               |               |                |                |
+-----------------------------------+---------------+---------------+----------------+----------------+
| Rural                             | 0.220         | **0.0021**    | 0.030          | 0.7195         |
|                                   |               |               |                |                |
|                                   |               | **\*\*\***    |                |                |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **Total people in the household** | 0.0571        | **0.0241**    | 0.0101         | 0.6772         |
|                                   |               |               |                |                |
|                                   |               | **\*\*\*\***  |                |                |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **Past Month total Income**       |               |               |                |                |
+-----------------------------------+---------------+---------------+----------------+----------------+
| 0 - \$999                         | 0.043         | 0.67          | -0.0130        | 0.890          |
+-----------------------------------+---------------+---------------+----------------+----------------+
| \$1,000 - \$1,999                 | 0.161         | **0.0439**    | 0.190          | **0.013**      |
|                                   |               |               |                |                |
|                                   |               | **\*\*\***    |                | **\*\*\***     |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **Language preference**           |               |               |                |                |
...
| Spanish                           | -0.03         | 0.897         | --             | --             |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **Machismo**                      | 0.105         | **0.003**     | 0.062          | 0.066          |
|                                   |               |               |                |                |
|                                   |               | **\*\*\*\***  |                |                |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **Caballerismo**                  | 0.088         | **0.046**     | 0.158          | **0.0006**     |
|                                   |               |               |                |                |
|                                   |               | **\*\*\***    |                | **\*\*\***     |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **Family Conflict**               | 0.072         | **0.001**     | 0.063          | **0.006**      |
|                                   |               |               |                |                |
|                                   |               | **\*\*\***    |                | **\*\*\***     |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **Family Religiosity**            | 0.052         | **0.003**     | 0.055          | **0.004**      |
|                                   |               |               |                |                |
|                                   |               | **\*\*\***    |                | **\*\*\***     |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **Family Control**                | 0.092         | **\< .0001**  | 0.071          | **0.0003**     |
|                                   |               |               |                |                |
|                                   |               | **\*\*\***    |                | **\*\*\***     |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **Americanism**                   | 0.071         | 0.237         | -0.166         | **0.015**      |
|                                   |               |               |                |                |
|                                   |               |               |                | **\*\*\***     |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **Hispanicism**                   | -0.153        | 0.001         | -0.137         | **0.026**      |
|                                   |               |               |                |                |
|                                   |               |               |                | **\*\*\***     |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **U.S. Born**                     |               |               |                |                |
+-----------------------------------+---------------+---------------+----------------+----------------+
| Yes                               | 0.262         | **0.0002**    | 0.238          | **0.014**      |
|                                   |               |               |                |                |
|                                   |               | **\*\*\***    |                | **\*\*\***     |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **MACV RSP**                      | -0.08         | 0.095         | -0.175         | **0.002**      |
|                                   |               |               |                |                |
|                                   |               |               |                | **\*\*\***     |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **MACV REL**                      | 0.030         | 0.35          | --             | --             |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **Father Drinking Frequency**     | 0.0006        | 0.78          | --             | --             |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **Father Drinking Quantity**      | -0.015        | 0.156         | --             | --             |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **Father Binge Drink**            | 0.136         | 0.064         | --             | --             |
+-----------------------------------+---------------+---------------+----------------+----------------+
| **Father Years in the U.S.**      | 0.0067        | **0.016**     | -0.005         | 0.20           |
|                                   |               |               |                |                |
|                                   |               | **\*\*\***    |                |                |
+-----------------------------------+---------------+---------------+----------------+----------------+
...
**HSI_Y and time**, there was no significant differences. This was expected as this is more of a cohort approach.

HSI_Y and Parent marital status: No significant association between HSI_Y and parent marital status.

HSI_Y and age: no significant association between HSI_Y and age but it is important to probably keep age in the model so we control for this.

HSI_Y and semi-rural /urban: those in the semi rural group reported higher levels of stress than those in the urban group.

HSI_Y and people in the household was significantly associated with hispanic stress.

HSI_Y and household income: type 3 F test was not significant so this may not be a good model fit, however some parameters were significant see below:
